...
* [x] Implement collapse scrolling effects on the Twitter profile view using `CoordinatorLayout`.
...
* [x] User can open navigation drawer via a pull from the left

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/5XI2PL3.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
CoordinatorLayout/AppBarLayout/CollapsingToolBarlayout was really hard to get a hand of. Implementing the navigation drawer was a bit tricky too.
...
## License
    ...
    Copyright [2016] [Emilio Arroyo-Fang]
